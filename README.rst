...
2. Get the code::
    ...
    $ git clone ssh://git@bitbucket.org/maykinmedia/bfeu
    $ cd bfeu
...
``src/bfeu/conf/settings_local.py``. You can base this file on
...
Note that your wsgi script in ``src/bfeu/wsgi.py already
